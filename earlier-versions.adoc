...
[role="lead"]
Se non si utilizza Astra Trident 22.10, è disponibile la documentazione relativa alle release precedenti. È possibile utilizzare il selettore della versione per passare dalla versione più recente alle quattro versioni precedenti o utilizzare i collegamenti riportati di seguito.
